...
int main(void) {
    ...
    char vowels [] {'a', 'e', 'i', 'o', 'u'};   // compiler determines size of array based on the number of elements
...
//    cin >> vowels[5]; // out of bounds - don't do this!!!
    ...
    // program produces junk with no initialization
    int test_scores[5] {};
    ...
    // prints the memory address of the first index as a representative of the array
