 ...
 *  Purpose: illustrate section challenge
 *  Date: 05/29/2023 
 * 
 *  Instructions:
 * 
 ...
 *          Display the elements in vector2 using the at() method as well as its size using
 *          the size() method
 * 
...
int main(void) {
    ...
    cout << "This program illustrates the requirements" << endl;
    cout << "for the Chapter 7 challenge." << endl;
